  ...
  const loadChatHistory = async () => {
    try {
      const response = await fetch(
        `/api/chat-history?resourceId=${userId}&threadId=${threadId}`,
      );
  ...
  return (
    ...
    >
      ...
      >
        ...
        Thread: <code>{threadId}</code> | History: {chatHistory.length} messages
        <button
      ...
      >
        ...
        >
          ...
          <p style={{ margin: 0, color: '#666', fontSize: '0.9rem' }}>
            Try: "I'm a brilliant AI engineer but I'm underpaid" | Your
            conversations are now saved!
          </p>
        </div>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        >
          ...
          >
            ...
            <p>
              SQLite storage with LibSQL is now configured! Your conversations
